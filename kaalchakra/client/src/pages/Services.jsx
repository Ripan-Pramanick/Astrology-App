...
const ServiceCard = ({ icon, title, subtitle, oldPrice, newPrice }) => {
  return (
    <div className="flex flex-col items-center text-center group cursor-pointer">
      ...
      <Button size="sm" className="mt-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300" onClick={() => window.location.href = '/kundli'}>
        Order Now
      </Button>
    </div>
  );
  ...
  const servicesData = [
    {
      ...
      subtitle: "Overall with 3 areas of concern",
      oldPrice: "15000",
      newPrice: "11000",
      icon: (
