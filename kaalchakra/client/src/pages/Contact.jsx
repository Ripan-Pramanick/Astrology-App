...
const api = {
  get: async (url) => {
    ...
    return { data: { success: false } }; // Fallback to default contact info
  },
  post: async (url, data) => {
              ...
              <div className="bg-white rounded-2xl shadow-md border border-gray-100 p-6">
                ...
                <div className="space-y-3">
                  <ContactInfoCard 
                    ...
                    color="grad-card-orange"
                  />
                  <ContactInfoCard 
                    icon={Mail} 
                    title="Email" 
                    details={contactInfo.emails}
                    color="grad-card-blue"
                  />
                  <ContactInfoCard 
                    icon={Phone} 
                    title="Phone" 
                    details={contactInfo.phones}
                    color="grad-card-green"
                  />
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-md border border-gray-100 p-6 md:p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="w-full grad-btn text-white font-semibold py-3.5 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {submitting ? (
                      <>
