const generateDivisionalCharts = (data) => {
    // --- Constants & Coordinates for SVG Chart ---
    const C = 100 / 350;
    ...
    const drawChart = (chartConfig) => {
        ...
        HOUSES_POLYGONS.forEach(h => {
            ...
            const fillStyle = isLagna ? 'rgba(161, 73, 59, 0.1)' : 'transparent'; 
            
            svgPolygons += `<polygon points="${h.points}" fill="${fillStyle}" stroke="#a1493b" stroke-width="0.5" stroke-linejoin="round" />`;
    ...
    // --- Mock Data for Divisional Charts (Will be replaced by API data) ---
    const d9Planets = data.d9Planets || data.planets;
    const d10Planets = data.d10Planets || data.planets; 

    // Generate Pages - One Chart Per Page
    const chartConfigs = [
        { title: "Navamsa Chart (D-9)", subtitle: "Marriage, Inner Self & Dharma", ascendant: "Taurus", planets: d9Planets },
        { title: "Dasamsa Chart (D-10)", subtitle: "Career, Power & Achievements", ascendant: "Leo", planets: d10Planets }
    ];
        ...
        <div class="page-container">
            <div class="content-wrapper">
                ...
                <div class="section-header">
                    <h2 class="section-title">Divisional Charts</h2>
                    <div class="gold-line"></div>
                    <p class="section-subtitle">Micro-analysis of specific life aspects (Vargas)</p>
                </div>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .charts-grid {
            display: flex; flex-direction: column; width: 100%; align-items: center; justify-content: center; flex-grow: 1;
        }
        ...
        /* Chart Size increased since they are on separate pages now */
        .chart-container {
            width: 130mm; height: 130mm; position: relative; background-color: #ffffff;
            border: 1px solid rgba(161, 73, 59, 0.2); padding: 5mm; box-shadow: 0 0 15px rgba(0,0,0,0.03);
        }
