...
const generateYearlyPredictions = (data) => {
    ...
    // 🌟 ১২০ বছরের (পূর্ণ আয়ু) লুপ তৈরি করা হলো
    let yearlyData = data.varshaphal || [];
    if (yearlyData.length < 120) {
        const currentYear = new Date().getFullYear();
        for(let i = yearlyData.length; i < 120; i++) {
            yearlyData.push({ 
            ...
            <div class="page-container">
                <div class="content-wrapper">
                    <div class="section-header">
                        ...
                        <p class="section-subtitle">${t.year || "Year"}: ${yearObj.year}</p>
                    </div>

                    <div class="year-block">
                        <div class="year-header">
                            <h3 class="year-title">Varshaphal (Annual Horoscope) Analysis</h3>
                            <div class="year-theme">Muntha Position: House ${yearObj.muntha_house}</div>
                        </div>
                        ...
                        <div class="year-content">
                            ...
                            <p class="year-text">
                                ...
                                The placement of the Muntha (annual progressed ascendant) in house ${yearObj.muntha_house} indicates that the themes of this house will be highly prominent. 
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* 🌟 এখানেই জাদু! প্রতিটি লুপের পর নতুন পেজ তৈরি হবে */
