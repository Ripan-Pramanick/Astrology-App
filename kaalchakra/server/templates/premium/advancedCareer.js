...
const generateAdvancedCareer = (data) => {
    ...
    // Fallback data for Premium Career Analysis
    const careerData = data.careerAnalysis || {
        tenthLord: "Mars",
        tenthLordPosition: "Exalted in 1st House",
        amatyakaraka: "Jupiter", // Planet with 2nd highest degree, shows career path
        d10Ascendant: "Leo",
        ...
        <div class="content-wrapper">
            ...
            <div class="indicators-grid">
                <div class="indicator-card">
                    <span class="indicator-label">10th Lord (Profession)</span>
                    <span class="indicator-value">${careerData.tenthLord}</span>
                    <div class="indicator-sub">${careerData.tenthLordPosition}</div>
                </div>
                <div class="indicator-card">
                    <span class="indicator-label">Amatyakaraka (Career Soul)</span>
                    <span class="indicator-value">${careerData.amatyakaraka}</span>
                    <div class="indicator-sub">Primary Guiding Force</div>
                </div>
                <div class="indicator-card">
                    <span class="indicator-label">Dasamsa (D-10) Ascendant</span>
                    <span class="indicator-value">${careerData.d10Ascendant}</span>
                    <div class="indicator-sub">Professional Environment</div>
                </div>
            </div>

            <!-- Professional Profile -->
            <div class="analysis-section">
                <h3 class="analysis-heading">Professional Profile & Karma</h3>
                <div class="analysis-text">
                    ${careerData.aiProfile}
                </div>
            </div>

            <!-- Favorable Fields & Work Style -->
            <div style="display: flex; gap: 20px; margin-bottom: 25px;">
                <div class="tags-section" style="flex: 1;">
                    <h4 style="font-size: 14px; color: #a1493b; text-transform: uppercase;">Favorable Sectors</h4>
                    <div class="tags-container">
                        ${fieldsHtml}
                    </div>
                </div>
                <div class="tags-section" style="flex: 1;">
                    <h4 style="font-size: 14px; color: #15803d; text-transform: uppercase;">Your Work Style</h4>
                    <div class="tags-container">
                        ${stylesHtml}
                    </div>
                </div>
            ...
            <div class="analysis-section" style="margin-bottom: 0;">
                <h3 class="analysis-heading">Wealth & Financial Potential</h3>
